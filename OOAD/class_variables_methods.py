...
To create a class method a decorator called --> class method
"""
class Student:
    college_name="CET"
...
# print(Student.department_name,student3.college_name,student1.department_name,Student.music("guitar"))
